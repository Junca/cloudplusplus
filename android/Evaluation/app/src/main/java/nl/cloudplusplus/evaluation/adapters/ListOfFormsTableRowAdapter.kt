...
class ListOfFormsTableRowAdapter(private var formArrayList: Array<Form>) :
    RecyclerView.Adapter<ListOfFormsTableRowAdapter.ViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val v: View = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.list_of_forms_table_row_layout, viewGroup, false)
        return ViewHolder(v)
    }
